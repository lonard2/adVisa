...
class SavedDocumentViewModel: ObservableObject {
    ...
    @Published var cardData: [Document] = [
        ...
        Document(icon: "", imageName: "template", documentName: "Self Portrait", explanation: "A full-color clear image with a solid background. If you want to use an existing image, make sure that it’s taken no longer than 6 months ago. See the photo guide as the picture above.")
    ]
